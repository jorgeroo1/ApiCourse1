...
class Category
{
    ...
    //el fetch:EXTRA_LAZY modificara nuestra consulta como select count(*) from
    //si no lo ponemos la consulta de nuestra página principal sera un select con
    //todos los campos de la entidad FortuneCookie
    ...
    public function getFortuneCookiesStillInProduction(): Collection{
        ...
        //para poder usarla usamos el matching, los objetos Criteria no hacen consultas asi que
        //el metodo puedes ser estático
